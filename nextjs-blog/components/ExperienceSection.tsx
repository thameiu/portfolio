...
const ExperienceSection = () => {
  ...
  return (
    <div className="fade-in-section w-full max-w-[90vw] md:max-w-4xl mx-auto bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl p-5 md:p-8 ">
      {/* Tab Navigation */}
      <div className="flex flex-row flex-wrap justify-center gap-2 md:gap-3 mb-5 md:mb-8">
        <button
          onClick={() => handleTabChange("experience")}
          className={`min-w-[28%] md:min-w-0 md:w-auto px-4 py-2.5 md:px-6 md:py-3 rounded-[25px] cursor-pointer text-sm md:text-base transition-all duration-300 font-['Sora'] font-medium ${
              ...
              <div className="group relative pl-0 md:pl-12 mb-8 md:mb-10">
                ...
                <div className="bg-transparent p-4 md:p-6 transition-all duration-300 hover:bg-white/10 border border-transparent hover:border-white/20 rounded-2xl">
                  <div className="flex flex-col gap-2 mb-3">
                    ...
                    <h3 className="text-lg md:text-2xl font-bold text-white group-hover:text-[var(--color-accent)] transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              <div className="group bg-white/5 hover:bg-white/10 rounded-2xl p-4 md:p-5 border border-white/10 hover:border-white/20 transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  <FaDesktop className="text-white/80 group-hover:text-[var(--color-accent)] transition-colors text-lg md:text-xl" />
                  <h4 className="text-base md:text-lg font-bold text-white group-hover:text-[var(--color-accent)] transition-colors">Frontend</h4>
                </div>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="group bg-white/5 hover:bg-white/10 rounded-2xl p-4 md:p-5 border border-white/10 hover:border-white/20 transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  <FaServer className="text-white/80 group-hover:text-[var(--color-accent)] transition-colors text-lg md:text-xl" />
                  <h4 className="text-base md:text-lg font-bold text-white group-hover:text-[var(--color-accent)] transition-colors">Backend</h4>
                </div>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="group bg-white/5 hover:bg-white/10 rounded-2xl p-4 md:p-5 border border-white/10 hover:border-white/20 transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  <FaDatabase className="text-white/80 group-hover:text-[var(--color-accent)] transition-colors text-lg md:text-xl" />
                  <h4 className="text-base md:text-lg font-bold text-white group-hover:text-[var(--color-accent)] transition-colors">Bases de données</h4>
                </div>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="group bg-white/5 hover:bg-white/10 rounded-2xl p-4 md:p-5 border border-white/10 hover:border-white/20 transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  <FaTools className="text-white/80 group-hover:text-[var(--color-accent)] transition-colors text-lg md:text-xl" />
                  <h4 className="text-base md:text-lg font-bold text-white group-hover:text-[var(--color-accent)] transition-colors">Outils</h4>
                </div>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="group bg-white/5 hover:bg-white/10 rounded-2xl p-4 md:p-5 border border-white/10 hover:border-white/20 transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  <FaCode className="text-white/80 group-hover:text-[var(--color-accent)] transition-colors text-lg md:text-xl" />
                  <h4 className="text-base md:text-lg font-bold text-white group-hover:text-[var(--color-accent)] transition-colors">Langages</h4>
                </div>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="group bg-white/5 hover:bg-white/10 rounded-2xl p-4 md:p-5 border border-white/10 hover:border-white/20 transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  <FaLaptopCode className="text-white/80 group-hover:text-[var(--color-accent)] transition-colors text-lg md:text-xl" />
                  <h4 className="text-base md:text-lg font-bold text-white group-hover:text-[var(--color-accent)] transition-colors">Bureau</h4>
                </div>
                <div className="flex flex-wrap gap-2">
