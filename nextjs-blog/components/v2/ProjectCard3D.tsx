  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (useSimplifiedMotion) {
        ...
        gsap.set(contentRef.current,   { opacity: isMobile ? 1 : 0 });
        gsap.set(carouselRef.current,  { opacity: isMobile ? 1 : 0 });
      ...
      <div ref={panelRef}
        ...
        >
          ...
          <div style={{
            ...
            maxWidth: isMobile ? "100%" : "min(46vw, 760px)",
            display: "flex",
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.techStack.map(t => (
                    <span key={t} className="v2-tech-pill inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium tracking-wide border"
                      style={{ color: accentColor, borderColor: borderCol, background: `${accentColor}10`, fontFamily: "'Sora',sans-serif", borderRadius: 4, ["--pill-accent" as string]: accentColor }}>
          ...
          <div ref={carouselRef}
            style={{
              ...
              paddingLeft: "clamp(0.8rem,2vw,2.8rem)",
              opacity: 0,
            }}>
