        ...
        focused && mounted
            ? createPortal(
                  ...
                  >
                      ...
                      >
                          <div
                              className="v2-carousel-focus-stage"
                          >
                              {images.length > 1 && (
                                  <button
                                      onClick={(e) => {
                          ...
                          {images.length > 1 && (
                              <div
                                  className="v2-carousel-focus-desktop-dots"
                                  style={{
                                      marginTop: "1rem",
                                      gap: 6,
                                      justifyContent: "center",
