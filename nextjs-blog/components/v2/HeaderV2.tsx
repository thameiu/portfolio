    ...
    <>
      ...
      >
        <div ref={headerHoverRef} className="pointer-events-auto flex"
          ...
          {/* Desktop nav */}
          <nav className="hidden md:flex items-center justify-center h-[46px] p-0 rounded-md overflow-hidden backdrop-blur-sm shadow-lg w-max relative"
              ...
              {navItems.map((item, idx) => {
                ...
                return (
                  <li key={item.id}
                    ...
                    <div
                      className={`absolute inset-0 -z-0 transition-opacity duration-300 ${isFirst ? "rounded-l-md" : ""} ${isLast ? "rounded-r-md" : ""} ${isActive ? "opacity-100" : "opacity-0 group-hover:opacity-100"}`}
          ...
          <div className="md:hidden">
            {!menuVisible && (
              <button
                ...
                style={{ borderRadius: 8, background: `${PRIMARY}55` }}>
                <FaBars size={22}/>
              </button>
            )}
          </div>
                    ...
                    <li key={item.id}
                      ...
                      {isActive && (
                        <div
                          ...
                          style={{ borderRadius: 8, background: "rgba(136,17,17,0.1)" }}
                        />
                      )}
                    </li>
                  );
